...
import com.example.coletaplus.adapters.RankingAdapter // ✅ ESTA É A LINHA QUE CORRIGE O ERRO

class GamificationFragment : Fragment() {

    private lateinit var rvRanking: RecyclerView
    private lateinit var adapter: RankingAdapter // A referência agora é resolvida pelo import
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.activity_gamification_ranking, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<ImageView>(R.id.ivBack).setOnClickListener {
            // Em um fragment, a ação de "voltar" geralmente é tratada pela Activity que o hospeda
            activity?.onBackPressedDispatcher?.onBackPressed()
        }

        // Carrega os dados simulados para preencher a tela
        carregarRankingSimulado()
    }

    private fun inicializarViews(view: View) {
        rvRanking = view.findViewById(R.id.rvRanking)
        rank1Container = view.findViewById(R.id.llRank1)
        rank2Container = view.findViewById(R.id.llRank2)
        rank3Container = view.findViewById(R.id.llRank3)
        tvNameRank1 = view.findViewById(R.id.tvNameRank1)
        tvScoreRank1 = view.findViewById(R.id.tvScoreRank1)
        tvNameRank2 = view.findViewById(R.id.tvNameRank2)
        tvScoreRank2 = view.findViewById(R.id.tvScoreRank2)
        tvNameRank3 = view.findViewById(R.id.tvNameRank3)
        tvScoreRank3 = view.findViewById(R.id.tvScoreRank3)
    }
    ...
    private fun carregarRankingSimulado() {
        // Lista de dados falsos para teste
        ...
        // Chama a função que preenche a interface
